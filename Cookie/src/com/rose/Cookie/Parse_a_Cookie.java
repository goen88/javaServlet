 ...
 */
public class Parse_a_Cookie
{
	/**
	 * Upper bound on the number of cookie tokens to accept. The limit is based
	 * on the 4 different attributes (4.3.4) and the 20 cookie minimum (6.3)
	 * given in RFC 2109 multiplied by 2 to accomodate the 2 tokens in each
	 * name=value pair ("JSESSIONID=1234" is 2 tokens).
	 */
	 ...
	 * @param beginIndex
	 *            The index in cookies to begin parsing from, inclusive
	 */
	 ...
	 * 
	 * @param index
	 *            The index of the cookie token to return
	 */
